   ...
   <div id="sidebar-wrapper" data-simplebar="" data-simplebar-auto-hide="true">
     <div class="brand-logo">
      <a href="index.html">
       ...
       <h5 class="logo-text">My Portfolio Admin</h5>
     </a>
   </div>
   <div class="user-details">
    <div class="media align-items-center user-pointer collapsed" data-toggle="collapse" data-target="#user-dropdown">
      <div class="avatar"><img class="mr-3 side-user-img" src="https://via.placeholder.com/110x110" alt="user avatar"></div>
       ...
       <h6 class="side-user-name">Adil Sahito</h6>
      </div>
       </div>
   ...
   <ul class="sidebar-menu">
      ...
      <li>
		...
		<ul class="sidebar-submenu">
		  <li><a href="index.php"><i class="zmdi zmdi-dot-circle-alt"></i> My Information</a></li>
      ...
      <li>
        ...
        <ul class="sidebar-submenu">
    <li><a href="about_me.php"><i class="zmdi zmdi-dot-circle-alt"></i> About Me</a></li>
        <li><a href="portfolio.php"><i class="zmdi zmdi-dot-circle-alt"></i> Porfolio</a></li>
    <li><a href="pricing_package.php"><i class="zmdi zmdi-dot-circle-alt"></i>Services and Pricing</a></li>
        <li><a href="Resume.php"><i class="zmdi zmdi-dot-circle-alt"></i>Resume</a></li>
        <li><a href="contact.php"><i class="zmdi zmdi-dot-circle-alt"></i>Contact</a></li>
